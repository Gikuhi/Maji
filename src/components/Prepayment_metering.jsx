export default function Prepayment_metering(){
  document.title = "Prepayment Metering"
    return<>
     {/* Navbar */}
...
<div className="">
    <embed className="w-full h-lvh  border-none" src="src/assets/pdfs/Prepayment Metering Solution new.pdf"></embed>    
   </div>
    <br/> 
