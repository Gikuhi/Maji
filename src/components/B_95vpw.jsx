export default function B_95vpw(){

    document.title = "B 95vpw"
    return<>
    {/* Navbar */}
...
<div className="">
    <embed className="w-full h-lvh  border-none" src="src/assets/pdfs/B95 VPW Valve Control _ Prepaid Ultrasonic Water Meter new.pdf"></embed>    
   </div>
    <br/>
