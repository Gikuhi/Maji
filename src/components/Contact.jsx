        ...
        <div
            ...
            <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                <div className="lg:w-1/2 px-6">
                    ...
                    <a href="https://www.google.com/maps/place/Netpaq+Business+Systems+Ltd/@-1.2334186,36.8699001,17z/data=!3m1!4b1!4m6!3m5!1s0x182f172fa18989b1:0xcf06392b60002ba2!8m2!3d-1.233424!4d36.872475!16s%2Fg%2F1ptzvnpht?entry=ttu" className="mt-1">Astrol office park, Kiambu road</a>
                </div>
                <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                    <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
                    <a href="mailto:sales@majinet.com" className="text-red-500 leading-relaxed">sales@majinet.com</a>
                    <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">PHONE</h2>
                    <a href="tel:+254720491455" className="leading-relaxed">+254 720 491455</a>
                </div>
            </div>
        </div>
        <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
            <h2 className="text-gray-900 text-lg mb-1 font-medium title-font">Feedback</h2>
            <p className="leading-relaxed mb-5 text-gray-600">Share to us your experience with our services or any inquiries needed
            </p>
