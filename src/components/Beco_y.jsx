export default function Beco_y(){
  document.title = "Beco Y"
    return <>
     {/* Navbar */}
 ...
 <a className="w-fit h-fit btn btn-ghost text-xs">
  ...
  <a href="/portal"><span className="menu-text text-lg">System Portal</span></a>
    ...
    <div className="">
    <embed className="w-full h-lvh  border-none" src="src/assets/pdfs/BECO Y Ultrasonic Water Meter new.pdf"></embed>    
   </div>
    <br/>
