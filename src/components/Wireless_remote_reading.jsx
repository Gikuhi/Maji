export default function Wireless_remote_reading(){
  document.title = "Wireless Remote Reading"
    return <>
    {/* Navbar */}
...
<div className="">
    <embed className="w-full h-lvh  border-none" src="src/assets/pdfs/Wireless Remote Reading Solution new.pdf"></embed>    
   </div>
    <br/>
