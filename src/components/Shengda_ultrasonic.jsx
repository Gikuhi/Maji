export default function Shengda_ultrasonic(){
  document.title = "Shengda Ultrasonic"
    return <>
     {/* Navbar */}
...
<div className="">
    <embed className="w-full h-lvh  border-none" src="src/assets/pdfs/Shengda Ultrasonic Water Meter new.pdf"></embed>    
   </div>
    <br/>
