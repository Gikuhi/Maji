export default function Wired_remote_reading(){
  document.title = "Wired Remote Reading"
    return<>
     {/* Navbar */}
...
<div className="">
    <embed className="w-full h-lvh  border-none" src="src/assets/pdfs/Wired Remote Reading Solution new.pdf"></embed>    
   </div>
    <br/>
