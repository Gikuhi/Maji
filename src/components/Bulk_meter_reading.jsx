export default function Bulk_meter_reading(){
  document.title = "Bulk Meter Reading"
    return <>
    {/* Navbar */}
...
<div className="">
    <embed className="w-full h-lvh  border-none" src="src/assets/pdfs/Bulk Meter Remote Reading Solution new.pdf"></embed>    
   </div>
    <br/>
